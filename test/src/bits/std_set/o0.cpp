...
#endif
                         ,
                         xstd::basic_bit_fixed_set<uint8_t, 0>, xstd::basic_bit_fixed_set<uint8_t, 1>, xstd::basic_bit_fixed_set<uint8_t, 7>, xstd::basic_bit_fixed_set<uint8_t, 8>, xstd::basic_bit_fixed_set<uint8_t, 9>, xstd::basic_bit_fixed_set<uint8_t, 15>, xstd::basic_bit_fixed_set<uint8_t, 16>, xstd::basic_bit_fixed_set<uint8_t, 17>, xstd::basic_bit_fixed_set<uint8_t, 24>, xstd::basic_bit_fixed_set<uint16_t, 0>, xstd::basic_bit_fixed_set<uint16_t, 1>, xstd::basic_bit_fixed_set<uint16_t, 15>, xstd::basic_bit_fixed_set<uint16_t, 16>, xstd::basic_bit_fixed_set<uint16_t, 17>, xstd::basic_bit_fixed_set<uint16_t, 31>, xstd::basic_bit_fixed_set<uint16_t, 32>, xstd::basic_bit_fixed_set<uint16_t, 33>, xstd::basic_bit_fixed_set<uint16_t, 48>, xstd::basic_bit_fixed_set<uint32_t, 0>, xstd::basic_bit_fixed_set<uint32_t, 1>, xstd::basic_bit_fixed_set<uint32_t, 31>, xstd::basic_bit_fixed_set<uint32_t, 32>, xstd::basic_bit_fixed_set<uint32_t, 33>, xstd::basic_bit_fixed_set<uint32_t, 63>, xstd::basic_bit_fixed_set<uint32_t, 64>, xstd::basic_bit_fixed_set<uint32_t, 65>, xstd::basic_bit_fixed_set<uint64_t, 0>, xstd::basic_bit_fixed_set<uint64_t, 1>, xstd::basic_bit_fixed_set<uint64_t, 63>, xstd::basic_bit_fixed_set<uint64_t, 64>, xstd::basic_bit_fixed_set<uint64_t, 65>
...
#endif
                         ,
                         xstd::basic_bit_set<uint8_t>, xstd::basic_bit_set<uint64_t>, xstd::bits::detail::set_adaptor<xstd::bits::detail::contiguous_bit_container<test::minimal_words<uint8_t>>>>;
