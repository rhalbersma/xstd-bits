...
{
        static_assert(std::derived_from<xstd::bit_set_view<Blocks>, xstd::set_adaptor<Blocks, xstd::ownership::refers, xstd::bit_set_view<Blocks>>>);
...
// The set ordering against std::set rather than a restatement of it, for every viewed type.
