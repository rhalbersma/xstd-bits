...
{
        constexpr auto word = xstd::bit_set_adaptor(xstd::from_bits, std::uint16_t{0b1000'0000'0000'0101});
        ...
        constexpr auto words = xstd::bit_set_adaptor(xstd::from_bits, std::array<std::uint8_t, 3>{0x01, 0x00, 0x80});
