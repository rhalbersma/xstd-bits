...
using Types = std::tuple<boost::dynamic_bitset<>, std::bitset<0>, std::bitset<1>, std::bitset<31>, std::bitset<32>, std::bitset<33>, std::bitset<63>, std::bitset<64>, std::bitset<65>, xstd::basic_bitset<uint8_t, 0>, xstd::basic_bitset<uint8_t, 1>, xstd::basic_bitset<uint8_t, 7>, xstd::basic_bitset<uint8_t, 8>, xstd::basic_bitset<uint8_t, 9>, xstd::basic_bitset<uint8_t, 15>, xstd::basic_bitset<uint8_t, 16>, xstd::basic_bitset<uint8_t, 17>, xstd::basic_bitset<uint8_t, 24>, xstd::basic_bitset<uint16_t, 0>, xstd::basic_bitset<uint16_t, 1>, xstd::basic_bitset<uint16_t, 15>, xstd::basic_bitset<uint16_t, 16>, xstd::basic_bitset<uint16_t, 17>, xstd::basic_bitset<uint16_t, 31>, xstd::basic_bitset<uint16_t, 32>, xstd::basic_bitset<uint16_t, 33>, xstd::basic_bitset<uint16_t, 48>, xstd::basic_bitset<uint32_t, 0>, xstd::basic_bitset<uint32_t, 1>, xstd::basic_bitset<uint32_t, 31>, xstd::basic_bitset<uint32_t, 32>, xstd::basic_bitset<uint32_t, 33>, xstd::basic_bitset<uint32_t, 63>, xstd::basic_bitset<uint32_t, 64>, xstd::basic_bitset<uint32_t, 65>, xstd::basic_bitset<uint64_t, 0>, xstd::basic_bitset<uint64_t, 1>, xstd::basic_bitset<uint64_t, 63>, xstd::basic_bitset<uint64_t, 64>, xstd::basic_bitset<uint64_t, 65>
...
#endif
                         ,
                         xstd::basic_dynamic_bitset<uint8_t>, xstd::basic_dynamic_bitset<uint64_t>>;
