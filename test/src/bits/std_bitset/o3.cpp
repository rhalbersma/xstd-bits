...
using Types = std::tuple<boost::dynamic_bitset<>, std::bitset<0>, std::bitset<17>, xstd::basic_bitset<uint8_t, 0>, xstd::basic_bitset<uint8_t, 8>, xstd::basic_bitset<uint8_t, 9>, xstd::basic_bitset<uint8_t, 17>, xstd::basic_bitset<uint16_t, 17>, xstd::basic_bitset<uint32_t, 17>, xstd::basic_bitset<uint64_t, 17>
