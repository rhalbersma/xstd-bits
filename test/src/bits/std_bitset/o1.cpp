...
using Types = std::tuple<boost::dynamic_bitset<>, std::bitset<0>, std::bitset<1>, std::bitset<64>, xstd::basic_bitset<uint8_t, 0>, xstd::basic_bitset<uint8_t, 1>, xstd::basic_bitset<uint8_t, 8>, xstd::basic_bitset<uint8_t, 9>, xstd::basic_bitset<uint8_t, 16>, xstd::basic_bitset<uint8_t, 17>, xstd::basic_bitset<uint8_t, 24>, xstd::basic_bitset<uint16_t, 24>, xstd::basic_bitset<uint32_t, 24>, xstd::basic_bitset<uint64_t, 24>
