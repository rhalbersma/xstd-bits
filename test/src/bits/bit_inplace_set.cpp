...
{
        static_assert(std::derived_from<T, xstd::detail::bits::set_adaptor<xstd::detail::bits::contiguous_bit_inplace_vector<std::uint8_t, 24>, xstd::detail::bits::storage::owned, T>>);
