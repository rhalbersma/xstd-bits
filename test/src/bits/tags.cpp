...
#include <xstd/bits/tags.hpp>       // array_container_tag, bitset_reading_tag, container_tag, inplace_vector_container_tag, reading_tag, sequence_reading_tag, set_reading_tag, vector_container_tag
