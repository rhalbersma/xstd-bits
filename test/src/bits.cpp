...
BOOST_AUTO_TEST_CASE(EveryContainerArrivesThroughTheUmbrella)
{
        ...
        static_assert(std::same_as<xstd::basic_bit_static_set<std::uint8_t, 8>, xstd::set_adaptor<xstd::detail::bits::contiguous_bit_array<std::uint8_t, 8>, xstd::storage::owned>>);
        static_assert(std::same_as<xstd::basic_bit_set<std::uint8_t>, xstd::set_adaptor<xstd::detail::bits::contiguous_bit_vector<std::uint8_t>, xstd::storage::owned>>);
