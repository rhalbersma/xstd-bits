...
class bit_subspan : public sequence_adaptor<Bits, storage::borrowed, true, bit_subspan<Bits>>
{
        using base_type = sequence_adaptor<Bits, storage::borrowed, true, bit_subspan<Bits>>;
