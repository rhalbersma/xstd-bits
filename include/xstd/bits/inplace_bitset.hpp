...
class basic_inplace_bitset : public bits::detail::bitset_adaptor<bits::detail::contiguous_bit_container<std::inplace_vector<Block, bits::detail::num_blocks_v<Block, N>>, N>, basic_inplace_bitset<Block, N>>
{
        using base_type = bits::detail::bitset_adaptor<bits::detail::contiguous_bit_container<std::inplace_vector<Block, bits::detail::num_blocks_v<Block, N>>, N>, basic_inplace_bitset<Block, N>>;
...
public:
        ...
        [[nodiscard]] basic_inplace_bitset() noexcept = default;

        [[nodiscard]] constexpr explicit basic_inplace_bitset(size_type num_bits, unsigned long long value = 0ULL)
        ...
        [[nodiscard]] constexpr basic_inplace_bitset(BlockInputIterator first, BlockInputIterator last)
                : base_type(first, last)
        {}

        [[nodiscard]] basic_inplace_bitset(basic_inplace_bitset const& b) = default;
        [[nodiscard]] basic_inplace_bitset(basic_inplace_bitset&& b) noexcept = default;

        ~basic_inplace_bitset() = default;

        auto operator=(basic_inplace_bitset const& b) -> basic_inplace_bitset& = default;
        auto operator=(basic_inplace_bitset&& b) noexcept -> basic_inplace_bitset& = default;

        // Not in boost::dynamic_bitset: flat_set's container constructor under the bit-storage tag.
        [[nodiscard]] constexpr basic_inplace_bitset(from_bit_storage_t, block_container_type blocks) noexcept
...
basic_inplace_bitset(from_bit_storage_t, std::inplace_vector<Block, K>) -> basic_inplace_bitset<Block, bit_storage_extent_v<Block> * K>;
