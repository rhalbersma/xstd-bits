...
#include <xstd/bits/basic_bits.hpp>                   // basic_bits, set_reading_tag, vector_container_tag
...
using basic_bit_set = basic_bits<set_reading_tag, vector_container_tag, Block, std::dynamic_extent, Allocator>;
