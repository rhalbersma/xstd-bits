...
class basic_bit_inplace_set : public adaptor<set_reading_tag, bits_t<inplace_vector_container_tag, Block, N>, storage::owned, window::all, basic_bit_inplace_set<Block, N>>
{
        using base_type = adaptor<set_reading_tag, bits_t<inplace_vector_container_tag, Block, N>, storage::owned, window::all, basic_bit_inplace_set<Block, N>>;
