...
#include <xstd/bits/basic_bits.hpp>                  // array_container_tag, basic_bits, bitset_reading_tag
...
using basic_bitset = basic_bits<bitset_reading_tag, array_container_tag, Block, N>;
